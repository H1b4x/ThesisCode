...
XGB_DIR = BASE_DIR / "final" / "XGB" / "nolag_corrected"
...
def objective(trial):
    ...
    for train_index, val_index in tscv.split(X_train):
        ...
        model = xgb.train(params, dtrain, num_boost_round=500, evals=[(dval, "eval")], early_stopping_rounds=20, verbose_eval=False)
